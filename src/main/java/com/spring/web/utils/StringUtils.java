...
public class StringUtils {
    ...
    public static boolean isDouble(Object obj) {
        return !isNullOrEmpty(obj) && (obj instanceof Double || obj instanceof Float || compileRegex("[-+]?\\d+\\.\\d+").matcher(obj.toString()).matches());
    }
    ...
    public static boolean contains(Object arr[], Object... obj) {
        return !(arr == null || obj == null || arr.length == 0) && Arrays.asList(arr).containsAll(Arrays.asList(obj));
    }
